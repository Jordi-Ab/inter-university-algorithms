...
| **2. Polygon Integration** | Quadrature & Computational Geometry | [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Jordi-Ab/inter-university-algorithms/main?labpath=polygon-integration) | *(Coming soon)* |
...
* Includes validation routines, blocking pair detection, automated unit tests, and reference infographic.
